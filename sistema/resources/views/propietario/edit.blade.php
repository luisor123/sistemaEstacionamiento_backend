		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<form action="{{route('propietario.update',$model->id)}}" method="POST" class="form-horizontal">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" 
                                    id="nombre" name="nombre" value="{{$model->nombre}}" placeholder="Nombre">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" 
                                    id="apellido" name="apellido" value="{{$model->apellido}}" placeholder="Apellido">
                                </div>
                            </div>
